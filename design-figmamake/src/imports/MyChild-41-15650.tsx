import svgPaths from "./svg-sdslmwhmkr";
...
import { imgImage1012 } from "./svg-wczxv";
...
function Frame5() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 top-0 w-[360px]">
      <div className="bg-[#8b6c34] h-[24px] shrink-0 w-full" />
      <Frame10 />
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full">
      <p className="css-ew64yg font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[18px] not-italic relative shrink-0 text-[14px] text-white">Dora P.</p>
    </div>
  );
}
...
function Frame27() {
  return (
    <div className="bg-gradient-to-r content-stretch flex from-[#d38c2f] gap-[8px] items-center px-[12px] py-[4px] relative rounded-[12px] shrink-0 to-[#e4cb71]">
      <div className="relative shrink-0 size-[16px]">
        <img alt="" className="block max-w-none size-full" height="16" src={imgEllipse1644} width="16" />
      </div>
      <p className="css-ew64yg font-['Inter:Bold',sans-serif] font-bold leading-[18px] not-italic relative shrink-0 text-[12px] text-white">Gold</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-h-px min-w-px relative">
      <div className="relative rounded-[40px] shrink-0 size-[28px]" data-name="image 20">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[40px] size-full" src={imgImage20} />
      </div>
      <Frame7 />
      <Frame27 />
    </div>
...
function Frame21() {
  return (
    <div className="content-stretch flex items-center relative shrink-0">
      <p className="css-ew64yg font-['Inter:Bold',sans-serif] font-bold leading-[18px] not-italic relative shrink-0 text-[12px] text-white">32.000 Point</p>
    </div>
  );
}
...
function Frame23() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <p className="css-ew64yg font-['Inter:Regular',sans-serif] font-normal leading-[18px] not-italic relative shrink-0 text-[12px] text-white">24.000 Point</p>
      <Frame21 />
    </div>
  );
}
...
function Group1() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid items-[start] justify-items-[start] leading-[0] relative shrink-0">
      <div className="bg-[#bb8528] col-1 h-[12px] ml-0 mt-0 rounded-[8px] row-1 w-[312px]" />
      <div className="bg-white col-1 h-[12px] ml-0 mt-0 rounded-[8px] row-1 w-[106px]" />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-full">
      <div className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px not-italic relative text-[12px] text-white">
        ...
        <p className="css-4hzbpn">naik ke Tier Diamond</p>
      </div>
      <Frame38 />
    </div>
  );
...
function Container1() {
  return (
    <div className="bg-[#daa549] relative rounded-[12px] shrink-0 w-full" data-name="Container">
...
function Frame31() {
  return (
    <div className="bg-[#9b651d] content-stretch flex flex-col items-start relative rounded-[12px] shrink-0 w-full">
      <Container />
      <Container1 />
    </div>
  );
...
export default function MyChild() {
  return (
    <div className="bg-[#f7f9fd] relative size-full" data-name="My Child">
      <div className="absolute h-[300px] left-0 rounded-bl-[28px] top-0 w-[360px]" style={{ backgroundImage: "linear-gradient(90deg, rgba(4, 35, 81, 0.14) 0%, rgba(4, 35, 81, 0.14) 100%), linear-gradient(90deg, rgb(218, 165, 73) 0%, rgb(218, 165, 73) 100%)" }} />
      <Frame5 />
      <Frame25 />
      <Frame26 />
    </div>
