...
const svgPaths = {
    ...
    // Discovery icon paths - grid of 4 squares with sparkle
    discoveryGrid: "M3 5C3 3.89543 3.89543 3 5 3H8C9.10457 3 10 3.89543 10 5V8C10 9.10457 9.10457 10 8 10H5C3.89543 10 3 9.10457 3 8V5ZM8 5H5V8H8V5ZM3 16C3 14.8954 3.89543 14 5 14H8C9.10457 14 10 14.8954 10 16V19C10 20.1046 9.10457 21 8 21H5C3.89543 21 3 20.1046 3 19V16ZM8 16H5V19H8V16ZM14 16C14 14.8954 14.8954 14 16 14H19C20.1046 14 21 14.8954 21 16V19C21 20.1046 20.1046 21 19 21H16C14.8954 21 14 20.1046 14 19V16ZM19 16H16V19H19V16ZM14 5C14 3.89543 14.8954 3 16 3H19C20.1046 3 21 3.89543 21 5V8C21 9.10457 20.1046 10 19 10H16C14.8954 10 14 9.10457 14 8V5ZM19 5H16V8H19V5Z",
    discoverySparkle: "M19 1L19.5 2.5L21 3L19.5 3.5L19 5L18.5 3.5L17 3L18.5 2.5L19 1Z",
};
...
function DiscoveryIcon({ active }: { active: boolean }) {
    return (
        <div className="relative shrink-0 size-[24px]">
            <Image
                src="/assets/icons/discovery.svg"
                alt="Discovery"
                width={24}
                height={24}
                className={active ? "brightness-0 saturate-100" : ""}
                style={active ? { filter: "invert(56%) sepia(52%) saturate(559%) hue-rotate(140deg) brightness(94%) contrast(87%)" } : {}}
            />
        </div>
    );
}
