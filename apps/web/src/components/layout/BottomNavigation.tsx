...
const svgPaths = {
    ...
    // Discovery icon paths (grid with sparkle)
    discoverySquare1: "M3 5C3 3.89543 3.89543 3 5 3H9C10.1046 3 11 3.89543 11 5V9C11 10.1046 10.1046 11 9 11H5C3.89543 11 3 10.1046 3 9V5ZM9 5H5V9H9V5Z",
    discoverySquare2: "M3 15C3 13.8954 3.89543 13 5 13H9C10.1046 13 11 13.8954 11 15V19C11 20.1046 10.1046 21 9 21H5C3.89543 21 3 20.1046 3 19V15ZM9 15H5V19H9V15Z",
    discoverySquare3: "M13 5C13 3.89543 13.8954 3 15 3H19C20.1046 3 21 3.89543 21 5V9C21 10.1046 20.1046 11 19 11H15C13.8954 11 13 10.1046 13 9V5ZM19 5H15V9H19V5Z",
    discoverySparkle: "M17 13C17.5523 13 18 13.4477 18 14V16H20C20.5523 16 21 16.4477 21 17C21 17.5523 20.5523 18 20 18H18V20C18 20.5523 17.5523 21 17 21C16.4477 21 16 20.5523 16 20V18H14C13.4477 18 13 17.5523 13 17C13 16.4477 13.4477 16 14 16H16V14C16 13.4477 16.4477 13 17 13Z",
};
...
function DiscoveryIcon({ active }: { active: boolean }) {
    return (
        <div className="relative shrink-0 size-[24px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
                <g>
                    <path clipRule="evenodd" d={svgPaths.discoverySquare1} fill={active ? "#20A4B0" : "#959DAC"} fillRule="evenodd" />
                    <path clipRule="evenodd" d={svgPaths.discoverySquare2} fill={active ? "#20A4B0" : "#959DAC"} fillRule="evenodd" />
                    <path clipRule="evenodd" d={svgPaths.discoverySquare3} fill={active ? "#20A4B0" : "#959DAC"} fillRule="evenodd" />
