  ...
  return (
    <div className="bg-white relative rounded-[12px] shrink-0 w-full">
      ...
      <div className="content-stretch flex flex-col gap-[12px] items-start p-[12px] relative w-full">
        ...
        <Link href="/discovery" className="h-[133px] overflow-hidden relative rounded-[12px] shrink-0 w-full bg-gradient-to-r from-[#b8eff3]/85 to-[#34CE9E]">
          <Image
        ...
        <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
          ...
          <Link href="/discovery" className="font-['Inter'] font-semibold leading-[16px] not-italic relative shrink-0 text-[#20a4b0] text-[12px] text-center">Lihat Semua</Link>
        </div>
      </div>
    </div>
  );
